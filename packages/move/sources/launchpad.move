module deployment_addr::launchpad_double_whitelist {
    ...
    /// Only admin can create allowlist
    ...
    fun add_mint_stage(
        ...
        assert!(vector::length(&allowlist) == vector::length(&allowlist_mint_limit_per_addr), EALLOWLIST_AND_MINT_LIMIT_PER_ADDR_MUST_BE_SAME_LENGTH);
