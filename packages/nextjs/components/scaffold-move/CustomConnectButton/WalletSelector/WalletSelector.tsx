import {
  ...
  import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "./wallet-ui/collapsible";
  import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from "./wallet-ui/dialog";
  import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
    DropdownMenuTrigger,
  } from "./wallet-ui/dropdown-menu";
  ...
  function ConnectWalletDialog({ close }: ConnectWalletDialogProps) {
    ...
    console.log("AVH wallets", wallets);
    ...
    return (
      <DialogContent className="max-h-screen overflow-auto">
        <AboutAptosConnect renderEducationScreen={renderEducationScreen}>
          ...
          {false ? ( // TODO: true or false? TRUE = allow social login
            <>
